...
lib.recursiveConcat [
  {
    ...
    overlays.default = lib.composeManyExtensions (
      let
        overlays = attrValues nixosModules.overlays;
      in
      map (o: import o { inherit inputs lib overlays; }) overlays
    );
  }
  (lib.foreach buildPlatforms (
    buildPlatform:
    let
      pkgs = lib.pkgsFor {
    ...
    in
    {
      ...
      packages.${buildPlatform} = allConfigs // {
